<section class="relative overflow-hidden bg-neutral-900">
    ...
    <div class="absolute inset-0 w-full h-full">
        <img src="{{ asset('assets/images/home/partners/bg/pt-bg.png') }}" 
             alt="Background" 
            ...
            <div class="max-w-7xl mx-auto pt-4">
                <div class="swiper partners-swiper">
                    <div class="swiper-wrapper">
                        @foreach(glob(public_path('assets/images/home/partners/*.png')) as $path)
                            <div class="swiper-slide flex items-center justify-center">
<img src="{{ asset('assets/images/home/partners/' . basename($path)) }}" 
     alt="Partner Logo" 
