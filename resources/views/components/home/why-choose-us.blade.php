    ...
    <div class="why-choose-container">
        ...
        <div class="why-choose-stats">
            <div class="stat-circle" data-aos="fade-up" data-aos-delay="100">
                <span class="stat-circle-number stat-counter" data-target="20" data-prefix="+">0</span>
                <span class="stat-circle-label">Year</span>
            </div>
            <div class="stat-circle" data-aos="fade-up" data-aos-delay="200">
                <span class="stat-circle-number stat-counter" data-target="60" data-prefix="+">0</span>
                <span class="stat-circle-label">Project</span>
            </div>
            <div class="stat-circle" data-aos="fade-up" data-aos-delay="300">
                <span class="stat-circle-number stat-counter" data-target="1200" data-prefix="+">0</span>
                <span class="stat-circle-label">Unit</span>
            </div>
        </div>
    </div>
</section>